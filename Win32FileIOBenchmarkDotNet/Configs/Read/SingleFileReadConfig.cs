...
{
    /// <summary>
    /// Implement class with benchmark settings to test <see cref="SingleReadFileBenchmark"/>
    /// </summary>
    public class SingleFileReadConfig : CommonConfig
    {
        #region Constructor

        public SingleFileReadConfig()
            => Add(
                Job.Default
